...
public class BLFacadeImplementation implements BLFacade {
	...
	/*
	 * @WebMethod public List<ApustuaContainer> findApustuaContainer(User u){
	 * dbManager.open(false); List<ApustuaContainer> a =
	 * dbManager.findApustuaContainer(u); dbManager.close(); return a; }
	 */
	@WebMethod
	...
	public IteratorEvents getEventsIterator(Date date) {

		return new IteratorEvents(this.getEvents(date));
